...
INSERT INTO change_profile_requests (name, surname, email, city, phone, car_type, baby_allowed, pets_allowed)
    VALUES ('Perica', 'Peric', 'pera@gmail.com', 'Samac','42145135', 'COUPE', true, false),
            ('Simija', 'Radesic', 'zima@gmail.com', 'Samac','42145135', 'SUV', true, true);
...
INSERT INTO ride (ride_state, price, start_date_time, end_date_time, expected_duration, distance, route_id, driver_id)
   VALUES ('STARTED', 16.3, '2023-09-17 18:47:52.069', null, 100, 54.3, 1, 9),
            ('STARTED', 16.3, '2023-09-17 18:47:52.069', null, 100, 54.3, 2, 9),
            ('ENDED', 50.0, '2023-01-24 10:00:00', '2023-01-24 11:00:00', 60, 10.0, 1, 9),
            ('IN_PROGRESS', 75.0, '2023-01-02 10:00:00', null, 60, 15.0, 2, 10),
            ('ENDED', 100.0, '2023-01-03 10:00:00', '2023-01-03 11:00:00', 60, 20.0, 1, 10),
            ('SCHEDULED', 125.0, '2023-01-04 10:00:00', null, 60, 25.0, 2, 11),
