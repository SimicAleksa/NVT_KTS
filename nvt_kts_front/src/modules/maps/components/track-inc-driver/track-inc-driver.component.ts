...
@Component({
  selector: 'app-track-inc-driver',
  templateUrl: './track-inc-driver.component.html',
  styleUrls: ['./track-inc-driver.component.css']
})

export class TrackIncDriverComponent implements OnInit {
  options = {
    layers: [
