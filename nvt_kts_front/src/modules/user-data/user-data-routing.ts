...
import { CLIENT_REGISTRATION_URL, CLIENT_ADD_DRIVER_URL, CLIENT_EDIT_PROF_URL, CLIENT_APPROVEC_CHANGES_URL, CLIENT_REG_USR_DRIVES_HISTORY_URL, CLIENT_BLOCK_USER_URL } from 'src/config/client-urls';
...
export const routes: Routes = [
  ...
  { path: CLIENT_BLOCK_USER_URL, component: BlockUserPageComponent }
];
