...
@Component({
  selector: 'app-ride-details-for-admin',
  templateUrl: './ride-details-for-admin.component.html',
  styleUrls: ['./ride-details-for-admin.component.css']
})
export class RideDetailsForAdminComponent implements OnInit {
